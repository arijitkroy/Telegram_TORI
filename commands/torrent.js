...
async function uploadCommand(chatId, userMessage, sendMessage, file = null) {
...
uploadCommand.syntax = "/torrent - Upload a .torrent file and receive content as zip.";
uploadCommand.file = true;
